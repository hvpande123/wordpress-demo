...
if( ! defined( 'WCPSCWC_VERSION' ) ) {
	define( 'WCPSCWC_VERSION', '2.6.6' ); // Version of plugin
}
...
if( ! defined( 'WCPSCWC_PLUGIN_BUNDLE_LINK' ) ) {
	define('WCPSCWC_PLUGIN_BUNDLE_LINK','https://www.essentialplugin.com/wordpress-plugin/woo-product-slider-carousel-category/?utm_source=WP&utm_medium=Product-Slider&utm_campaign=Bundle-Banner#wpos-epb'); // Plugin link
}
...
if( ! defined( 'WCPSCWC_PLUGIN_LINK_WELCOME' ) ) {
	define('WCPSCWC_PLUGIN_LINK_WELCOME','https://www.essentialplugin.com/wordpress-plugin/woo-product-slider-carousel-category/?utm_source=WP&utm_medium=Product-Slider&utm_campaign=Welcome-Screen#wpos-epb'); // Plugin Check link
}
